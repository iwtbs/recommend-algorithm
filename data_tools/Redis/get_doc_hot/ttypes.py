...
class ArticleInfo:
  ...
  thrift_spec = (
    ...
    (13, TType.STRING, 'account_region', None, None, ), # 13
    (14, TType.I32, 'account_weight', None, None, ), # 14
    (15, TType.I32, 'acc_subscribe_num', None, None, ), # 15
  ...
  def __init__(self, _id=None, url=None, topic=None, title_simhash=None, top5_keyword_sign=None, title=None, locate=None, locate_enable=None, account=None, account_openid=None, account_topic_list=None, account_tag_list=None, account_region=None, account_weight=None, acc_subscribe_num=None, original_sig=None, video_sig=None, group_type=None, page_time=None, source_type=None, kw_list=None, tag_list=None, merge_tag_list=None, quality_score=None, op_time=None, coeff_score=None, score=None, target_word=None, recall_reason_score=None, weixin_read_num=thrift_spec[30][4], app_read_num=thrift_spec[31][4], app_show_num=thrift_spec[32][4], app_read_duration=thrift_spec[33][4], app_favor_num=thrift_spec[34][4], app_collect_num=thrift_spec[35][4], app_share_num=thrift_spec[36][4], news_sogourank_pv=thrift_spec[37][4], news_comment_num=thrift_spec[38][4], news_participant_num=thrift_spec[39][4], article_attr_display=None, img_list=None, account_type=None, acc_region_level=None, acc_weixin_avg_read=None, acc_sogourank_avg_read=None, acc_app_avg_click=None, acc_app_avg_show=None, acc_app_avg_favor=None, acc_app_avg_share=None, acc_app_avg_duration=None, porn_score=None, base_quality_score=None,):
    ...
    self.acc_subscribe_num = acc_subscribe_num
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.account_region = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 14:
        if ftype == TType.I32:
        ...
        if ftype == TType.I32:
          self.acc_subscribe_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 16:
        if ftype == TType.I32:
  ...
  def write(self, oprot):
    ...
    if self.account_region is not None:
      oprot.writeFieldBegin('account_region', TType.STRING, 13)
      oprot.writeString(self.account_region)
      oprot.writeFieldEnd()
    if self.account_weight is not None:
      oprot.writeFieldBegin('account_weight', TType.I32, 14)
      oprot.writeI32(self.account_weight)
      oprot.writeFieldEnd()
    if self.acc_subscribe_num is not None:
      oprot.writeFieldBegin('acc_subscribe_num', TType.I32, 15)
      oprot.writeI32(self.acc_subscribe_num)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self._id)
    value = (value * 31) ^ hash(self.url)
    value = (value * 31) ^ hash(self.topic)
    value = (value * 31) ^ hash(self.title_simhash)
    value = (value * 31) ^ hash(self.top5_keyword_sign)
    value = (value * 31) ^ hash(self.title)
    value = (value * 31) ^ hash(self.locate)
    value = (value * 31) ^ hash(self.locate_enable)
    value = (value * 31) ^ hash(self.account)
    value = (value * 31) ^ hash(self.account_openid)
    value = (value * 31) ^ hash(self.account_topic_list)
    value = (value * 31) ^ hash(self.account_tag_list)
    value = (value * 31) ^ hash(self.account_region)
    value = (value * 31) ^ hash(self.account_weight)
    value = (value * 31) ^ hash(self.acc_subscribe_num)
    value = (value * 31) ^ hash(self.original_sig)
    value = (value * 31) ^ hash(self.video_sig)
    value = (value * 31) ^ hash(self.group_type)
    value = (value * 31) ^ hash(self.page_time)
    value = (value * 31) ^ hash(self.source_type)
    value = (value * 31) ^ hash(self.kw_list)
    value = (value * 31) ^ hash(self.tag_list)
    value = (value * 31) ^ hash(self.merge_tag_list)
    value = (value * 31) ^ hash(self.quality_score)
    value = (value * 31) ^ hash(self.op_time)
    value = (value * 31) ^ hash(self.coeff_score)
    value = (value * 31) ^ hash(self.score)
    value = (value * 31) ^ hash(self.target_word)
    value = (value * 31) ^ hash(self.recall_reason_score)
    value = (value * 31) ^ hash(self.weixin_read_num)
    value = (value * 31) ^ hash(self.app_read_num)
    value = (value * 31) ^ hash(self.app_show_num)
    value = (value * 31) ^ hash(self.app_read_duration)
    value = (value * 31) ^ hash(self.app_favor_num)
    value = (value * 31) ^ hash(self.app_collect_num)
    value = (value * 31) ^ hash(self.app_share_num)
    value = (value * 31) ^ hash(self.news_sogourank_pv)
    value = (value * 31) ^ hash(self.news_comment_num)
    value = (value * 31) ^ hash(self.news_participant_num)
    value = (value * 31) ^ hash(self.article_attr_display)
    value = (value * 31) ^ hash(self.img_list)
    value = (value * 31) ^ hash(self.account_type)
    value = (value * 31) ^ hash(self.acc_region_level)
    value = (value * 31) ^ hash(self.acc_weixin_avg_read)
    value = (value * 31) ^ hash(self.acc_sogourank_avg_read)
    value = (value * 31) ^ hash(self.acc_app_avg_click)
    value = (value * 31) ^ hash(self.acc_app_avg_show)
    value = (value * 31) ^ hash(self.acc_app_avg_favor)
    value = (value * 31) ^ hash(self.acc_app_avg_share)
    value = (value * 31) ^ hash(self.acc_app_avg_duration)
    value = (value * 31) ^ hash(self.porn_score)
    value = (value * 31) ^ hash(self.base_quality_score)
    return value
...
class HotFeature:
  ...
  Attributes:
   ...
   - comment_like_num
   - total_read_duration
   - app_read_duration_double
   - real_show_num
   - coldstart_show_num
   - coldstart_real_show_num
   - coldstart_read_num
   - coldstart_valid_duration_num
   - coldstart_read_duration
  """
  ...
  thrift_spec = (
    ...
    (13, TType.DOUBLE, 'cur_hot_score', None, None, ), # 13
    (14, TType.DOUBLE, 'cur_trend_score', None, None, ), # 14
    (15, TType.I32, 'cur_read_num', None, None, ), # 15
    (16, TType.I32, 'cur_show_num', None, None, ), # 16
    (17, TType.I32, 'valid_duration_num', None, None, ), # 17
    (18, TType.I32, 'comment_num', None, None, ), # 18
    (19, TType.I32, 'comment_reply_num', None, None, ), # 19
    (20, TType.I32, 'comment_like_num', None, None, ), # 20
    (21, TType.I64, 'total_read_duration', None, None, ), # 21
    (22, TType.DOUBLE, 'app_read_duration_double', None, None, ), # 22
    (23, TType.I32, 'real_show_num', None, None, ), # 23
    (24, TType.I32, 'coldstart_show_num', None, None, ), # 24
    (25, TType.I32, 'coldstart_real_show_num', None, None, ), # 25
    (26, TType.I32, 'coldstart_read_num', None, None, ), # 26
    (27, TType.I32, 'coldstart_valid_duration_num', None, None, ), # 27
    (28, TType.I64, 'coldstart_read_duration', None, None, ), # 28
  )

  def __init__(self, op_time=thrift_spec[1][4], weixin_read_num=thrift_spec[2][4], app_read_num=thrift_spec[3][4], app_show_num=thrift_spec[4][4], app_read_duration=thrift_spec[5][4], app_favor_num=thrift_spec[6][4], app_collect_num=thrift_spec[7][4], app_share_num=thrift_spec[8][4], news_sogourank_pv=thrift_spec[9][4], news_comment_num=thrift_spec[10][4], news_participant_num=thrift_spec[11][4], sogou_search_index=thrift_spec[12][4], cur_hot_score=None, cur_trend_score=None, cur_read_num=None, cur_show_num=None, valid_duration_num=None, comment_num=None, comment_reply_num=None, comment_like_num=None, total_read_duration=None, app_read_duration_double=None, real_show_num=None, coldstart_show_num=None, coldstart_real_show_num=None, coldstart_read_num=None, coldstart_valid_duration_num=None, coldstart_read_duration=None,):
    self.op_time = op_time
    self.weixin_read_num = weixin_read_num
    self.app_read_num = app_read_num
    self.app_show_num = app_show_num
    ...
    self.cur_hot_score = cur_hot_score
    self.cur_trend_score = cur_trend_score
    self.cur_read_num = cur_read_num
    self.cur_show_num = cur_show_num
    self.valid_duration_num = valid_duration_num
    self.comment_num = comment_num
    self.comment_reply_num = comment_reply_num
    self.comment_like_num = comment_like_num
    self.total_read_duration = total_read_duration
    self.app_read_duration_double = app_read_duration_double
    self.real_show_num = real_show_num
    self.coldstart_show_num = coldstart_show_num
    self.coldstart_real_show_num = coldstart_real_show_num
    self.coldstart_read_num = coldstart_read_num
    self.coldstart_valid_duration_num = coldstart_valid_duration_num
    self.coldstart_read_duration = coldstart_read_duration
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.DOUBLE:
          self.cur_hot_score = iprot.readDouble()
        else:
          iprot.skip(ftype)
      elif fid == 14:
        if ftype == TType.DOUBLE:
          self.cur_trend_score = iprot.readDouble()
        else:
          iprot.skip(ftype)
      elif fid == 15:
        if ftype == TType.I32:
          self.cur_read_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 16:
        if ftype == TType.I32:
          self.cur_show_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 17:
        if ftype == TType.I32:
          self.valid_duration_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 18:
        if ftype == TType.I32:
        ...
        if ftype == TType.I32:
          self.comment_reply_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 20:
        if ftype == TType.I32:
          self.comment_like_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 21:
        if ftype == TType.I64:
          self.total_read_duration = iprot.readI64()
        else:
          iprot.skip(ftype)
      elif fid == 22:
        if ftype == TType.DOUBLE:
          self.app_read_duration_double = iprot.readDouble()
        else:
          iprot.skip(ftype)
      elif fid == 23:
        if ftype == TType.I32:
          self.real_show_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 24:
        if ftype == TType.I32:
          self.coldstart_show_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 25:
        if ftype == TType.I32:
          self.coldstart_real_show_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 26:
        if ftype == TType.I32:
          self.coldstart_read_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 27:
        if ftype == TType.I32:
          self.coldstart_valid_duration_num = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 28:
        if ftype == TType.I64:
          self.coldstart_read_duration = iprot.readI64()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.sogou_search_index is not None:
      ...
      oprot.writeFieldEnd()
    if self.cur_hot_score is not None:
      oprot.writeFieldBegin('cur_hot_score', TType.DOUBLE, 13)
      oprot.writeDouble(self.cur_hot_score)
      oprot.writeFieldEnd()
    if self.cur_trend_score is not None:
      oprot.writeFieldBegin('cur_trend_score', TType.DOUBLE, 14)
      oprot.writeDouble(self.cur_trend_score)
      oprot.writeFieldEnd()
    if self.cur_read_num is not None:
      oprot.writeFieldBegin('cur_read_num', TType.I32, 15)
      oprot.writeI32(self.cur_read_num)
      oprot.writeFieldEnd()
    if self.cur_show_num is not None:
      oprot.writeFieldBegin('cur_show_num', TType.I32, 16)
      oprot.writeI32(self.cur_show_num)
      oprot.writeFieldEnd()
    if self.valid_duration_num is not None:
      oprot.writeFieldBegin('valid_duration_num', TType.I32, 17)
      oprot.writeI32(self.valid_duration_num)
      oprot.writeFieldEnd()
    if self.comment_num is not None:
      oprot.writeFieldBegin('comment_num', TType.I32, 18)
      oprot.writeI32(self.comment_num)
      oprot.writeFieldEnd()
    if self.comment_reply_num is not None:
      oprot.writeFieldBegin('comment_reply_num', TType.I32, 19)
      oprot.writeI32(self.comment_reply_num)
      oprot.writeFieldEnd()
    if self.comment_like_num is not None:
      oprot.writeFieldBegin('comment_like_num', TType.I32, 20)
      oprot.writeI32(self.comment_like_num)
      oprot.writeFieldEnd()
    if self.total_read_duration is not None:
      oprot.writeFieldBegin('total_read_duration', TType.I64, 21)
      oprot.writeI64(self.total_read_duration)
      oprot.writeFieldEnd()
    if self.app_read_duration_double is not None:
      oprot.writeFieldBegin('app_read_duration_double', TType.DOUBLE, 22)
      oprot.writeDouble(self.app_read_duration_double)
      oprot.writeFieldEnd()
    if self.real_show_num is not None:
      oprot.writeFieldBegin('real_show_num', TType.I32, 23)
      oprot.writeI32(self.real_show_num)
      oprot.writeFieldEnd()
    if self.coldstart_show_num is not None:
      oprot.writeFieldBegin('coldstart_show_num', TType.I32, 24)
      oprot.writeI32(self.coldstart_show_num)
      oprot.writeFieldEnd()
    if self.coldstart_real_show_num is not None:
      oprot.writeFieldBegin('coldstart_real_show_num', TType.I32, 25)
      oprot.writeI32(self.coldstart_real_show_num)
      oprot.writeFieldEnd()
    if self.coldstart_read_num is not None:
      oprot.writeFieldBegin('coldstart_read_num', TType.I32, 26)
      oprot.writeI32(self.coldstart_read_num)
      oprot.writeFieldEnd()
    if self.coldstart_valid_duration_num is not None:
      oprot.writeFieldBegin('coldstart_valid_duration_num', TType.I32, 27)
      oprot.writeI32(self.coldstart_valid_duration_num)
      oprot.writeFieldEnd()
    if self.coldstart_read_duration is not None:
      oprot.writeFieldBegin('coldstart_read_duration', TType.I64, 28)
      oprot.writeI64(self.coldstart_read_duration)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.news_comment_num)
    value = (value * 31) ^ hash(self.news_participant_num)
    value = (value * 31) ^ hash(self.sogou_search_index)
    value = (value * 31) ^ hash(self.cur_hot_score)
    value = (value * 31) ^ hash(self.cur_trend_score)
    value = (value * 31) ^ hash(self.cur_read_num)
    value = (value * 31) ^ hash(self.cur_show_num)
    value = (value * 31) ^ hash(self.valid_duration_num)
    value = (value * 31) ^ hash(self.comment_num)
    value = (value * 31) ^ hash(self.comment_reply_num)
    value = (value * 31) ^ hash(self.comment_like_num)
    value = (value * 31) ^ hash(self.total_read_duration)
    value = (value * 31) ^ hash(self.app_read_duration_double)
    value = (value * 31) ^ hash(self.real_show_num)
    value = (value * 31) ^ hash(self.coldstart_show_num)
    value = (value * 31) ^ hash(self.coldstart_real_show_num)
    value = (value * 31) ^ hash(self.coldstart_read_num)
    value = (value * 31) ^ hash(self.coldstart_valid_duration_num)
    value = (value * 31) ^ hash(self.coldstart_read_duration)
    return value
